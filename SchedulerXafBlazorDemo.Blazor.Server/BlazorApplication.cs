...
using SchedulerXafBlazorDemo.Blazor.Server.Services;

namespace SchedulerXafBlazorDemo.Blazor.Server {
    public partial class SchedulerXafBlazorDemoBlazorApplication : BlazorApplication {
        public SchedulerXafBlazorDemoBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void SchedulerXafBlazorDemoBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
